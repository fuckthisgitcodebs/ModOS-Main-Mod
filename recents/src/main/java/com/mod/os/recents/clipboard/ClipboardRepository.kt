...
class ClipboardRepository @Inject constructor(
    ...
    private val sensitivityDetector: SensitivityDetector
) {
    ...
    suspend fun addClipboardContent(
        ...
        val isSensitive = sensitivityDetector.isSensitive(trimmed, sourcePackage)

        val preview = if (trimmed.length > 200) trimmed.take(197) + "..." else trimmed
